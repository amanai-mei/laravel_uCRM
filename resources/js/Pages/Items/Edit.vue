...
const props = defineProps({ //受け取りのみでなく値の書き換えも行うので変数に代入する
    item: Object,
    errors: Object
})
...
const form = reactive({ //formに入力したらすぐに変更になるようにreactive対応をする
    // 編集の場合はnullではなく登録した値を持ってくる
    id: props.item.id,
...
// const updateItem = (id) => { の書き方でも可：引数が2個以上の場合は()が必須で引数が1個の場合は無くてもOK
const updateItem = id => {
    Inertia.put(route('items.update',{item: id}),form) //routeじゃなくURLでもOK
}
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font relative">
                            <!-- form.idで引数を指定しており、これが21行目のidにいく -->
                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="name" class="leading-7 text-sm text-gray-1000">商品名</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="price" class="leading-7 text-sm text-gray-1000">商品価格</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="is_selling" class="leading-7 text-sm text-gray-1000">ステータス</label><br>
