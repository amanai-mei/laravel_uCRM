...
const fetchAddress = () =>{
    new YubinBangoCore(String(form.postcode), (value) => {
        // form.address = value.region(都道府県) + value.locality(市町村) + value.street(町域)
        form.address = value.region + value.locality + value.street
    })
}

const storeCustomer = () => { //関数の名前をつける時は動詞＋名詞でつける store(動詞)Item(名詞)
                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="name" class="leading-7 text-sm text-gray-1000">顧客名</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="kana" class="leading-7 text-sm text-gray-1000">顧客名カナ</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="tel" class="leading-7 text-sm text-gray-1000">電話番号</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="email" class="leading-7 text-sm text-gray-1000">メールアドレス</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="postcode" class="leading-7 text-sm text-gray-1000">郵便番号</label>
                                                    <!-- @changeは入力が終わったら実行してくれる（郵便番号の入力が終わったらその郵便番号を元に住所を表示してくれる -->
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="address" class="leading-7 text-sm text-gray-1000">住所</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="birthday" class="leading-7 text-sm text-gray-1000">誕生日</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label class="leading-7 text-sm text-gray-1000">性別</label><br>
