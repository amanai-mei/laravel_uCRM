...
defineProps({
    customers: Object //ページネートを使う場合はarrayではなくobjectにする
})

const search = ref('')

//refの値を指定するには.valueが必要
// {search: search.value }で検索した文字を引数に渡す
                            ...
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                                    ...
                                    <Link :href="route('customers.create')">
                                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">顧客登録</button>
                                    </Link>
                                </div>
